...
/**
 * @typedef {object} Options The Options to use in the function edublockAPI.
...
/** Helper class to interact with theEdublock chain */
export default class edublockAPI {
  /**
   * Creates a new instance of the edublockAPI object, call init to initialize
