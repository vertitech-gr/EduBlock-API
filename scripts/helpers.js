 ...
 * @template T
 * @param {Object} params
 * @param {function(dock: edublockAPI, ...args: any[]): Promise<T>}
 * @returns {function(...args: any[]): Promise<T>}
 */
export const withedublockAPI = curry((params, fn) => async (...args) => {
  console.log("Connecting...");
  let err, res;
  const dockAPI = new edublockAPI();
