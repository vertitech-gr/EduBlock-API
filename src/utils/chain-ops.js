...
// XXX: Following info can be fetched from chain. Integrating in edublockAPI object is an option.
const TESTNET_ADDR_PREFIX = 21;
const MAINNET_ADDR_PREFIX = 22;
const DECIMAL = 6;
const SYMBOL = 'DCK';

// The methods below intentionally take an `ApiPromise` object to decouple from `edublockAPI` object.
